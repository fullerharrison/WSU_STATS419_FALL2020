...
Average participant hand width is reported as .1 and NBA basketball players report similar results. Hand width of an average participant is weakly correlated with reach (.32) and wingspan (.34) and some negative correlation with professional athletes reach, all features report a p-value < .05. Professional athlete hand width is weakly correlated with with professional hand length (.32) and professional wingspan (.17), where both values are reported with p-values < .001.


The reach of professional basketball players and average persons are reported as 1.3 for both groups. Professional athlete's reach has a weak negative correlation with an average person's hand width (-.16), moderate positive correlation with professional player hand length (.46) with corresponding p-values < .05. Correlations are observed with average hand width (.32) and wingspan (.42). The results of the t-test indicate significant differences between values (p < .01).
...
source("https://raw.githubusercontent.com/MonteShaffer/humanVerseWSU/master/misc/functions-project-measure.R");
...
source.to.local.function =  "/Users/harrisonfuller/OneDrive - Washington State University (email.wsu.edu)/Classes/STATS 419/WSU_STATS419_FALL2020/functions/";

source.to.local.libraries = "/Users/harrisonfuller/OneDrive - Washington State University (email.wsu.edu)/Classes/STATS 419/WSU_STATS419_FALL2020/libraries/";

path.project = "/Users/harrisonfuller/OneDrive - Washington State University (email.wsu.edu)/Classes/STATS 419/WSU_STATS419_FALL2020/project-measure/";

# Source libraries and functions
# 
source(paste0(source.to.local.libraries, "project-measure_libraries.R"))
source(paste0(source.to.local.function, "functions_project-measure.R"));


path.to.secret = "/Users/harrisonfuller/OneDrive - Washington State University (email.wsu.edu)/Classes/STATS 419/__student_access__/_SECRET_/";
...
# Get NBA data
# 
nba <- read_labelled_xlsx(filename = "/Users/harrisonfuller/OneDrive - Washington State University (email.wsu.edu)/Classes/STATS 419/WSU_STATS419_FALL2020/datasets/NBA.xlsx", 
                          data_sheet = "NBA Draft");
...
```{r,appendix-summary,message=FALSE, include=FALSE}


myData2 = as.matrix(cbind(measure.height.Xs[, -c(1:3, 6)],nba.height.Xs[-181:-193,-c(1:3, 6)]));
myNames2 = c("Hand Length (cm)", "Hand Width (cm)",  "Reach (cm)", "Wingspan (cm)",
            "Pro Hand Length (cm)", "Pro Hand Width (cm)", "Pro Reach (cm)", "Pro Wingspan (cm)");

buildLatexCorrelationTable(myData = myData2, 
                                myFile = paste0(getwd(),"/tables/","table-scale-correlation-measure-nba.tex"),
