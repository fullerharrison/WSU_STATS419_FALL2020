...
# path.to.secret = "WRITE-SOMETHING-HERE";
...
myNames = c("Hand Length (cm)", "Hand Width (cm)",  "Height (cm)", "Reach (cm)", "Wingspan (cm)",
            "Pro Hand Length (cm)", "Pro Hand Width (cm)", "Pro Height (cm)", "Pro Reach (cm)", "Pro Wingspan (cm)");
