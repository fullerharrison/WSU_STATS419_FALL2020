...
\hline
 & \\
\textbf{1} & \textbf{Hand Length (cm)} &  18&.5 &  &  1&.56 &  &  1&  &  &  \multicolumn{2}{c}{ \  \  \  \  \ }  &  &  \multicolumn{2}{c}{ \  \  \  \  \ }  &  &  \multicolumn{2}{c}{ \  \  \  \  \ }  &  & \\ 
 & \\
\textbf{2} & \textbf{Hand Width (cm)} &  20&.3 &  &  2&.17 &  &  &.76{$^{***}$}  &  &  1&  &  &  \multicolumn{2}{c}{ \  \  \  \  \ }  &  &  \multicolumn{2}{c}{ \  \  \  \  \ }  &  & \\ 
 & \\
\textbf{3} & \textbf{Height (cm)} &  168&.4 &  &  10&.98 &  &  &.64{$^{***}$}  &  &  &.66{$^{***}$}  &  &  1&  &  &  \multicolumn{2}{c}{ \  \  \  \  \ }  &  & \\ 
 & \\
