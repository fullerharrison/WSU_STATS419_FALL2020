...
\hypertarget{sec:rq4}{%
\subsection{This is a sentence}\label{sec:rq4}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{path.project =}\StringTok{ "/Users/harrison.fuller/OneDrive - Washington State University (email.wsu.edu)/Classes/STATS 419/WSU_STATS419_FALL2020/project-measure/"}\NormalTok{;}

\CommentTok{# paste0(local.path, "measure-students.txt"); }
\CommentTok{# }
